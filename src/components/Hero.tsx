...
export default function Hero() {
  ...
  return (
    <div className="flex flex-col bg-hero-image bg-cover max-xl:mt-20 max-lg:h-[500px] max-lg:bg-hero-image-mobile max-lg:bg-cover xl:h-[520px] 2xl:h-[800px]">
      ...
      <h3 className="animate-fadeInUp text-center font-bold uppercase text-white text-shadow animation-delay-1000 max-lg:mt-[190px] max-lg:text-lg xl:mt-20 xl:text-2xl 2xl:mt-[280px] 2xl:text-3xl">
