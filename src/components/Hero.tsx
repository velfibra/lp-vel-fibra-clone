  ...
  return (
    <div className="flex h-[800px] flex-col bg-gray-500 max-lg:h-[450px]">
      <div className="ml-20 mt-20 h-fit text-7xl max-lg:ml-2 max-lg:mt-5 max-lg:text-2xl">
        ...
        <div className="animate-fadeInLeft text-4xl animation-delay-700 max-lg:text-xl">
          ...
          <button className="mt-10 rounded-xl bg-secondary p-3 text-4xl font-semibold uppercase text-white shadow-md shadow-gray-800 duration-500 hover:scale-110 hover:bg-primary max-lg:mt-3 max-lg:text-xl">
            contratar agora
          </button>
        </div>
      </div>
      <h3 className="mt-44 animate-fadeInUp text-center text-4xl font-bold text-white animation-delay-1000 max-lg:mt-16 max-lg:text-xl">
