    ...
    <div className="flex h-[800px] flex-col bg-hero-image bg-cover max-xl:mt-20 max-lg:h-[500px]">
      <div className="ml-20 mt-20 h-fit text-7xl max-lg:ml-2 max-lg:mt-10 max-lg:text-2xl">
        <div className="animate-fadeInLeft animation-delay-300">
          <h1 className="text-white text-shadow">Cansado de ficar</h1>
          <h1 className="mb-3 mt-4 w-fit bg-white p-2 font-semibold uppercase text-primary">sem</h1>
        ...
        <div className="animate-fadeInLeft text-4xl animation-delay-700 max-lg:text-lg">
          <h2 className="mt-4 w-fit text-white text-shadow">Então vem para a Click Speed</h2>
          <h2 className="w-fit text-white text-shadow max-lg:w-[90%]">
      ...
      <h3 className="mt-44 animate-fadeInUp text-center text-3xl font-bold text-white text-shadow animation-delay-1000 max-lg:mt-28 max-lg:text-lg">
