...
const texts = [
  ...
  {
    question: 'Como posso contratar a Click Speed?',
    answer:
      'Você pode contratar a Click Speed direto pelo site, basta escolher o seu plano acima e clicar em ‘Contrate agora’. Você também pode contratar pelo número (91)3085-3190.',
  },
  {
    question: 'Onde posso ter suporte da Click Speed?',
    answer:
      'Você poderá falar com um de nossos especialistas através do WhatsApp (91)3085-3190, por direct em nossas redes sociais ou realizar seu auto atendimento na Área do Cliente neste site ou através do aplicativo da Click Speed.',
  },
];
