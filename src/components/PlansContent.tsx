...
export default function PlansContent() {
  ...
  return (
    <section className="mx-auto p-6 font-sans text-shadow max-lg:w-full">
      ...
      <div className="mx-auto -mt-5 flex justify-between max-lg:w-full max-lg:flex-col max-lg:items-center xl:w-[90%] xl:animate-fadeInUp 2xl:w-[70%]">
        {plans.map(({ h1, h2, id, price, mt, bg, bgButton, hover, icons, offer }) => (
          <div key={h1}>
            <Card
              className={`my-5 flex ${mt} h-[450px] w-[380px] flex-col gap-5 p-2 ${bg} text-white hover:scale-110 hover:duration-300 max-lg:h-[450px] max-lg:animate-fadeInUp`}
            >
              <div>
