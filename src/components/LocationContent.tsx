  ...
  return (
    <section className="flex flex-col bg-local-image bg-cover max-lg:h-[580px] max-lg:bg-local-image-mobile xl:h-[500px] 2xl:h-[600px]">
      <div className="flex flex-col max-lg:mb-5">
        <h1
          id="coverage"
          className="rise mb-5 animate-fadeInUp text-end font-bold uppercase text-white text-shadow animation-delay-150 max-lg:mr-0 max-lg:animate-fadeInLeft max-lg:text-center max-lg:text-3xl max-lg:text-[20px] max-lg:animation-delay-500 xl:mr-5 xl:text-[35px] 2xl:mr-20 2xl:text-[50px]"
        >
